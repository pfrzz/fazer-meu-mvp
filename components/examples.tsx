...
export default function Examples() {
  ...
  return (
    <section id="exemplos" className="py-20 bg-gradient-to-br from-gray-50 to-blue-50 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        <div className="grid lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
          {projects.map((project, index) => (
            <Card
              key={index}
              className="group relative overflow-hidden border-0 bg-white/40 backdrop-blur-xl hover:bg-white/60 transition-all duration-500 hover:scale-105 hover:shadow-2xl"
            >
